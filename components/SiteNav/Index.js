          ...
          <Col lg={9} md={12} sm={12}>
            <div className="main-menubar ul-li clearfix">
              <ul className="clearfix">
                <li>
                  <a href="#thetop" className="nav-link scrollspy-btn">
                    Home
                  </a>
                </li>
                <li>
                  <a href="#about-section" className="nav-link scrollspy-btn">
                    About
                  </a>
                </li>
                <li>
                  <a href="#service-section" className="nav-link scrollspy-btn">
                    Our Services
                  </a>
                </li>
                <li>
